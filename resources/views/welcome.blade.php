                    ...
                    <div class="advantages hidden-xs hidden-sm call-to-action">
                        ...
                        <div class="advantages__el" style="margin-top: 43px">
                            <div class="advantages__el-content"><img src="{{ asset('landing/img/coins.svg') }}">
                                ...
                                <p>The Tradeum TRM token allows users to trade with 60% less fees, have access to a unique
    ...
    <section class="token-utility container-padding" id="token-utility">
        <div class="container">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12 view-fix">
                <p>
                    The TRM token plays an integral role on the Tradeum platform. You will benefit from 60% off of
            ...
            <div class="container">
                <div class="community__pool row">
                    ...
                    <div class="col-md-8">
                        ...
                        <p>
                            The goal of this program is to provide TRM holders a sustainable, passive income opportunity
                ...
                <div class="services row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="single-service-item about__advantages-list__element">
                            ...
                            <div class="service-text">
                                <p class="description">
                                    <b>Arbitrage</b> between exchanges offering TRM by buying low and selling high.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="community__score row">
                    <div class="col-md-5 col-sm-6 col-xs-12">
                        ...
                        <p>
                            TRM token holders can be rewarded for accurately predicting market outcomes or providing useful
                ...
                <div class="community__score row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <p>
                            While buying or selling TRM, you will save 60% off of transaction costs. The TRM market will
                ...
                <li data-date="01/01/2018">
                    <div class="item-list row">
                        ...
                        <div class="item col-md-3 col-sm-3 col-xs-12">
                            ...
                            <p>TRM Smart Contract Creation</p>
                        </div>
                        <div class="item col-md-3 col-sm-3 col-xs-12">
            ...
            <div class="cards">
                <div class="card chart-wrap bg columns " style="flex-shrink: 0;">
                    ...
                    <div class="chart-legend invers">
                        <p>Presale, March 1st, 1.1M TRM</p>
                        <p>Round 1, March 10th, 3.8M TRM</p>
                        <p>Round 2, March 17th, 4.3M TRM</p>
                        <p>Round 3, March 24nd, 4.9M TRM</p>
                        <p>Round 4, April 1st, 5.4M TRM</p>
                    </div>
                </div>
                ...
                <div class="card chart-wrap bg ring" style="flex-shrink: 0;">
                    <h3>Initial TRM Distribution</h3>
                    <div class="chart">
                    ...
                    <div class="iq-accordion iq-mt-50">
                        ...
                        <div class="ad-block"><a href="#" class="ad-title iq-tw-6 iq-font-grey">What kind of return can
                            ...
                            <div class="ad-details">
                                ...
                                supply, the potential appreciation of the TRM token during the Pooling term, and the profits
                        ...
                        <div class="ad-block"><a href="#" class="ad-title iq-tw-6 iq-font-grey">What will bring people
                            ...
                            <div class="ad-details">
                                Beyond the many benefits of decentralized exchange, we believe that the utility of the TRM
                                ...
                                lowest exchange fees in the marketplace with the TRM token and the high potential for reward
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="iq-accordion iq-mt-50">
                        ...
                        <div class="ad-block"><a href="#" class="ad-title iq-tw-6 iq-font-grey">What are the benefits
                            of the TRM Token?</a>
                            <div class="ad-details">
                                The TRM token has many valuable functions and benefits on the Tradeum platform. These
